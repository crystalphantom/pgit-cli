...
# [0.10.0](/compare/v0.9.1...v0.10.0) (2026-06-24)


### Features

* add support for glob and exclude patterns in private config 7611d49
* support glob add excludes caf5464

## [0.9.1](https://github.com/crystalphantom/pgit-cli/compare/v0.9.0...v0.9.1) (2026-06-13)

### Bug Fixes

* **cli:** support the documented `pgit --version` flag

### Maintenance

* strengthen package install smoke tests for all version flags
* document npm publish recovery checks for version convergence
...
* fix release workflow validation to build before coverage tests so tagged releases can execute the integration smoke tests reliably
